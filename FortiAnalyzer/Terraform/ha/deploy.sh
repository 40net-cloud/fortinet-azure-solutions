...
#export TF_VAR_FAZ_BYOL_LICENSE_FILE_A=""
#export TF_VAR_FAZ_BYOL_LICENSE_FILE_B=""
#export TF_VAR_FAZ_BYOL_SERIAL_NUMBER_A=""
#export TF_VAR_FAZ_BYOL_SERIAL_NUMBER_B=""
