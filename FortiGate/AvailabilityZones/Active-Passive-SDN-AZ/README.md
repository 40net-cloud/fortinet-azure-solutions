...
`cd ~/clouddrive/ && wget -q -O main.zip https://github.com/40net-cloud/fortinet-azure-solutions/archive/refs/heads/main.zip && unzip main.zip && cd ~/clouddrive/fortinet-azure-solutions-main/FortiGate/AvailabilityZones/Active-Passive-SDN-AZ/ && ./deploy.sh`
