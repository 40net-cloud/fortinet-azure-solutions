...
This design operates almost exactly the same as the more common variant using Availability Sets that can be found [here](../../Active-Passive-ELB-ILB/README.md). The main difference between both is that this uses Availability Zones vs the Availability Sets.
