...
The deployment of the FortGate-VM in the Azure China region is similar to the Azure Global regions. More information about the global region deployment can be found [here](/FortiGate/Active-Passive-ELB-ILB/README.md).
