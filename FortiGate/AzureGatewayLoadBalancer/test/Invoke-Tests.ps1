<#
.SYNOPSIS
    Runs the AzureGatewayLoadBalancer ARM template Pester tests locally.
.DESCRIPTION
...
.PARAMETER OutputPath
    ...
    Default: <this-script-dir>/test-custom.xml
.EXAMPLE
    ./test/Invoke-Tests.ps1
    ./test/Invoke-Tests.ps1 -SSHKeyPath ~/.ssh/id_ed25519
#>
[CmdletBinding()]
param (
    [string]$SSHKeyPath    = "",
...
if (-not $OutputPath) {
    $OutputPath = "$testDir/test-custom.xml"
}
