...
After deployment, you will be shown the IP addresses of all deployed components. This information is also stored in the output directory in the 'summary.out' file. You can access the FortiGate management GUI using the public management IP address using HTTPS on port 443.
