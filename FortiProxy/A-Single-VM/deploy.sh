...
##############################################################################################################
#
# Deployment of a Single FortiProxy VM
#
##############################################################################################################
...
##############################################################################################################
#
# FortiProxy Azure deployment using ARM Template
# A single FortiProxy
#
# The FortiProxy systems is reachable via the public IP address of the firewall on HTTPS/443 and SSH/22.
#
##############################################################################################################
